...
#define CUSTOMHID_OFF_HID_DESC                  0x09//0x12
#define CUSTOMHID_OFF_HID_DESC1                  (50)
#define CUSTOMHID_OFF_HID_DESC2                  (82-9)


#define CUSTOMHID_SIZ_DEVICE_DESC               18
#define CUSTOMHID_SIZ_CONFIG_DESC              (41)// (105-9-9)//41
#define CUSTOMHID_SIZ_REPORT_DESC             (615)//181// 373//181//155//33 // 162 haleliu @20130122 modify
#define CUSTOMHID_SIZ_MOUSE_REPORT_DESC			(54)
...
extern const uint8_t  CustomHID_Mouse_ReportDescriptor[CUSTOMHID_SIZ_MOUSE_REPORT_DESC];
